                    ...
                    <tr class="{{ $loop->odd ? 'odd' : 'even bg-slate-50' }} is-editing" dusk="inline-item-{{ $item->id }}">
                        ...
                        <td data-title="Description">
                            <x-forms.textarea
                                name="description"
                                rows="1"
                                wire:model.live.debounce.500ms="editValues.description"
                        ...
                        <td data-title="Facility" class="text-center">
                            <x-forms.checkbox
                                ...
                                wire:model.live.debounce.500ms="editValues.is_facility"
                            />
                            ...
                            <div class="grid gap-4 grid-cols-1 lg:grid-cols-3 pb-4">
                                ...
                                <div>
                                    ...
                                    <x-forms.select
                                        ...
                                        multiple
                                        wire:model.live="editValues.categories"
                                    />
                                </div>
                                <div>
                                    ...
                                    <x-forms.select
                                        ...
                                        multiple
                                        wire:model.live="editValues.buckets"
                                    />
                                </div>
                            </div>
                        </td>
