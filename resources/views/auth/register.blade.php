        ...
        <div class="w-full sm:w-1/2 md:w-1/3">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-4{{ $errors->has('name') ? ' has-error' : '' }}">
                    <label for="name" class="label screen-reader">Name</label>
                ...
                <div class="mb-4{{ $errors->has('email') ? ' has-error' : '' }}">
                    <label for="email" class="label screen-reader">E-mail</label>
                ...
                <div class="mb-4{{ $errors->has('password') ? ' has-error' : '' }}">
                    <label for="password" class="label screen-reader">Password</label>
                ...
                <div class="mb-6">
                    <label for="password-confirm" class="label screen-reader">Confirm password</label>
